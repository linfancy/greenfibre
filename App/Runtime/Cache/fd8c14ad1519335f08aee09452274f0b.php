  ...
  <body>
    ...
    <div class="container-fluid">
      <div class="row-fluid">
        ...
        <div class="span9">
        <?php if(is_array($item)): $i = 0; $__LIST__ = $item;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$co): $mod = ($i % 2 );++$i;?><div class="row-fluid">
            <div class="span4">
              <h1><?php echo ($co["title"]); ?></h1>
              <h3><?php echo ($co["line1_title"]); ?>&nbsp<?php echo ($co["line1_title_en"]); ?></h3>
              <p><?php echo ($co["line1_text"]); ?><br><?php echo ($co["line1_text_en"]); ?></p>
              <p><a class="btn" href="<?php echo U('Admin/edit');?>/type/<?php echo ($co["product_type"]); ?>">详细 &raquo;</a></p>
            </div><!--/span-->
